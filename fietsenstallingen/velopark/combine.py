...
"@context": {
        ...
        "maximumParkingDuration": {
            "@id": "vp:maximumParkingDuration",
            "@type": "xsd:duration"
        },
        "openingHoursExtraInformation": {
            "@id": "vp:openingHoursExtraInformation",
            "@type": "xsd:string"
        },
        "intendedAudience": {
        ...
        "temporarilyClosed": {
            "@id": "vp:temporarilyClosed",
            "@type": "xsd:boolean"
        },
        "parkingDetails": "vpt:PublicBicycleParking"
    },
    '@graph': []
}

for filename in glob.glob('*.jsonld'):
    print(filename)
    with open(filename) as f:
        ...
        try:
            ...
            pass
        stations['@graph'].append(station)

with open('velopark.jsonld', 'w') as f:
